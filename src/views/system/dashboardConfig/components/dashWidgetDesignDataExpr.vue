<template>
    <div class="exprCon">
        <input  v-on:dblclick="open()" :value="value" class="noBorder" style="width: 100%; font-size: 13px;height: 27px; text-align: center;"></input>
        <!--<Button :type="type"  style="width: 215px; font-size: 13px;height: 27px; text-align: center;" v-on:dblclick="open()">{{value}}</Button>-->
