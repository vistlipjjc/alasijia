            ...
            <div class="lilTimeBox">
              <div class="lilTimeItem">
                <DatePicker type="date"
                  :value="queryForm.applyStartTime"
  ...
  data () {
    return {
      ...
      columns: [
        ...
        { title: '操作', align: 'center', key: 'action', width: 65, handler: [
          { action: 'view' }
        ]}
      ]
    }
    ...
    getOrganization () {
      ...
      vm.$net.send({
        ...
        if (data.code === 200) {
          ...
          vm.changeArrayToObject(vm.organizationObject, organizationJson)
