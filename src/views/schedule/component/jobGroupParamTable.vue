<template>
    <div>
        <Table :ref="refs" :columns="columnsList" :data="tableData"  disabled-hover size="small"
...
<script>
    ...
    const cellSelect = (vm, h, param, item) => {
        return h('Select', {
            ...
            h('Option', {props: {value: 'string'}},'字符串'),
            h('Option', {props: {value: 'number'}},'数字'),
            h('Option', {props: {value: 'date'}},'日期')
        ]);
    };
